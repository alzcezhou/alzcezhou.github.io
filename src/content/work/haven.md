---
title: "Haven"
subtitle: "Crowd-sourced harm reduction and accountability"
year: "2024"
...
<!-- TODO: Add image: Survey results and key statistics -->
<!-- TODO: Add image: User personas -->
...
<!-- TODO: Add image: Wireframes and style guide -->
...
<!-- TODO: Add image: Onboarding flow screens -->

### Harm Reduction

Consolidating resources into a single, map-based view reduces the cognitive load on users in high-stress moments. Crowdsourced ratings add a layer of peer trust that institutional directories lack. At a glance, students can see what services are offered, and evaluate how safe a provider is based on crowdsourced reviews.

<!-- TODO: Add image: Harm reduction map view and resource cards -->

### Incident Map

The core insight from our research was that students don't report because they fear being identified — not because they don't want to. Removing that barrier through anonymous, crowdsourced reporting creates a form of community accountability that exists entirely outside of institutional channels.

The toggle between Help and Harm modes keeps the two use cases distinct, preventing the app from feeling overwhelming while addressing both sides of the safety problem in one product.

<!-- TODO: Add image: Incident map view with toggle interaction -->
