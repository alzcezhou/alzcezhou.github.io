...
<div class="flex flex-wrap items-center gap-x-[32px] gap-y-2 mb-4">
  <span class="font-body text-base leading-relaxed">We chose to move forward with a design that accomplishes 2 things:</span>
  <HavenHarmToggle />
</div>
